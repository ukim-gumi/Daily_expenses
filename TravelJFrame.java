...
public class TravelJFrame extends JFrame implements MouseListener {
    ...
    public TravelJFrame(String username) {
    ...
    private void initView() {
        ...
        // 添加背景
        JLabel background = new JLabel(new ImageIcon(classLoader.getResource("background/出行旅行界面背景.png")));
    ...
    private void saveWaterElectricityData() {
        try {
            ...
            if (rows > 0) {
                JOptionPane.showMessageDialog(this, "出行旅游记录成功！");
                this.dispose(); // 关闭窗口
            }
