...
public class DailyNecessitiesJFrame extends JFrame implements MouseListener {
    ...
    public DailyNecessitiesJFrame (String username) {
    ...
    private void initView() {
        ...
        // 添加背景
        JLabel background = new JLabel(new ImageIcon(classLoader.getResource("background/生活用品界面背景.png")));
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource() == submitLabel) {
            System.out.println("生活用品提交按钮被点击");
    ...
    private void saveWaterElectricityData() {
        try {
            ...
            if (rows > 0) {
                JOptionPane.showMessageDialog(this, "生活用品记录成功！");
                this.dispose(); // 关闭窗口
            }
