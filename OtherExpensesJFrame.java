...
public class OtherExpensesJFrame extends JFrame implements MouseListener {
    ...
    public OtherExpensesJFrame(String username) {
    ...
    private void initView() {
        ...
        // 添加背景
        JLabel background = new JLabel(new ImageIcon(classLoader.getResource("background/其他界面背景.png")));
    ...
    private void saveWaterElectricityData() {
        try {
            ...
            if (rows > 0) {
                JOptionPane.showMessageDialog(this, "其他费用记录成功！");
                this.dispose(); // 关闭窗口
            }
